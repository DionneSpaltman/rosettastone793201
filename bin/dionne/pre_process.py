...
# We need to load the different languages 
nlp_dict ={
...
# We're creating a list of stop words for english
...
# We're creating a list of punctuations
...
# Import statements
# tqdm is a library that provides a fast, extensible progress bar for Python and CLI
...
df.to_csv("/Users/dionnespaltman/Desktop/Luiss /Machine Learning/Project/rs2_pre_processed.csv", index=False)
